...
YARN_OPTS="$YARN_OPTS -Dhadoop.log.dir=$HADOOP_LOG_DIR"
YARN_OPTS="$YARN_OPTS -Dyarn.log.dir=$HADOOP_LOG_DIR"
YARN_OPTS="$YARN_OPTS -Dhadoop.log.file=$YARN_LOGFILE"
YARN_OPTS="$YARN_OPTS -Dyarn.log.file=$YARN_LOGFILE"
YARN_OPTS="$YARN_OPTS -Dyarn.home.dir=$YARN_COMMON_HOME"
YARN_OPTS="$YARN_OPTS -Dyarn.id.str=$HADOOP_IDENT_STRING"
